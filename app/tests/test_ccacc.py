...
class TestCCProcModule(unittest.TestCase):
    ...
    def test_create_acc(self):
        acc = Account(accname='Alan', ccnum='946546', cclimit='$3000')


    def test_cln_amt(self):
       acc = Account(accname='Alan', ccnum='5454545454545454',cclimit='$3000')
       self.assertEqual(acc._cln_amt('$10000'), 10000)


    def test_update_cclimit(self):
       acc = Account(accname='Alan', ccnum='5454545454545454',cclimit='$300')
       acc.cclimit = '$850'
    ...
    def test_verify_acc_cc_num_change_invalid(self):
       ...
       self.assertEqual('error', acc.ccnum)


    def test_charge_acc_accepted(self):
        acc = Account(accname='Alan', ccnum='4111111111111111', cclimit='$3000')
    ...
    def test_charge_acc_success_then_decline(self):
        acc = Account(accname='Alan', ccnum='4111111111111111',cclimit='$1000')
    ...
    def test_credit_acc_above_zero(self):
        ...
        self.assertEqual(acc.accbalance, 2539)
    ...
    def test_credit_acc_below_zero(self):
        ...
        acc.charge_acc(chrgamt)
        acc.credit_acc(crdamt)
        self.assertEqual(acc.accbalance, -11)
    ...
    def test_verify_acc_cc_num_error(self):
        acc = Account(accname='Alan', ccnum='1234567890123456',cclimit='$3000')
        self.assertEqual('error', acc.ccnum)
